// let tamano = 8;
// let numero = 8;
// function crearFila(pTamano, pCasillas, pColor) {
//     let color = "";
//     let fila = "";
//     for (let i = 1; i <= pCasillas; i++) {
//         if (pColor == "rojo") {
//             color = (i % 2 != 0) ? 'rojo' : 'verde';
//         }
//         else {
//             color = (i % 2 != 0) ? 'verde' : 'rojo';
//         }
//         fila += '<div class="' + color + '" style="width: '  + '50px; height:' + '50px"></div>';
//     }
//     document.write('<div class="fila">' + fila + "</div>");
// }


// function crearTablero(pNumeroCasillas) {
//     for (let i = 1; i <= pNumeroCasillas; i++) {
//         let colorInicial = (i % 7 != 1) ? "rojo" : "verde";
//         crearFila(tamano, pNumeroCasillas, colorInicial);
//     }
// }
// crearTablero(numero);
...
checker.prototype.checkIfKing = function () {
	if(this.coordY == 8 && !this.king &&this.color == "white"){
		this.king = true;
		this.id.style.border = "4px solid #white";
	}
	if(this.coordY == 1 && !this.king &&this.color == "black"){
		this.king = true;
		this.id.style.border = "4px solid black";
	}
}
...
function erase_roads(piece){
	if(downRight) block[downRight].id.style.background = "black";
	if(downLeft) block[downLeft].id.style.background = "black";
	if(upRight) block[upRight].id.style.background = "black";
	if(upLeft) block[upLeft].id.style.background = "black";
}
